...
@section('title', page_title(__('Add an app feature')))
    ...
    <x-card no-wrap-pad class="mb-5">
        <x-slot name="header" class="border-b">
            ...
            <p class="text-sm text-slate-800">
                {{ __('Create a new feature to be linked to :app app.', ['app' => $app->name]) }}
            </p>
        </x-slot><!-- /.card-header -->

        <div x-data="" class="card-body">
            <form method="POST" action="{{ route('admin.apps.features.store', $app) }}">
                @csrf
                ...
                <div class="mt-4">
                    ...
                    <x-input class="w-full mt-2"
                       ...
                       type="text"
                       name="name"
                       placeholder="{{ __('Feature name, eg. CMS') }}"
                       value="{{ old('name') }}"
                       required
                       autofocus
                    />
                ...
                <div class="mt-4">
                    ...
                    <x-input class="w-full mt-2"
                       ...
                       type="text"
                       name="key"
                       placeholder="{{ __('A unique identifier for feature, eg. cms') }}"
                       value="{{ old('key') }}"
                    />
