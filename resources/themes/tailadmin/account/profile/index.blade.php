...
@section('title', page_title('Update Profile | Account'))
            ...
            <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <nav>
                    <ol class="flex items-center gap-2">
                        <li><a class="font-medium" href="{{ route('account.index') }}">{{ __('Account') }} /</a></li>
                        <li class="font-medium text-primary">{{ __('Profile') }}</li>
                    </ol>
                </nav>
            </div>
            <!-- Breadcrumb End -->
