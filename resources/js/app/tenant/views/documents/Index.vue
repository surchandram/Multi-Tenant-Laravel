...
<script setup>
  ...
  const {
    ...
    hasSelectedFilters,
    selectedLabels,
  } = useFilters(props.model.filters, 'tenant.documents.index');
...
<template>
  <Head :title="`Documents | ${$page.props.tenant.name}`" />
  ...
  <div class="flex flex-col gap-10 relative">
    ...
    <div class="w-full flex items-center mb-3">
      ...
      <div class="flex items-center gap-3">
        <AppSuccessButton :href="route('tenant.documents.create')">
          <i class="bi bi-file-plus"></i> Add Document
        </AppSuccessButton>
