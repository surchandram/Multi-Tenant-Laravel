...
<template>
  <Head :title="`${__('admin.labels.new_document')} | ${__('admin.labels.dashboard_title')}`" />
      ...
      <div>
        ...
        >
          ...
          <div class="mt-4 relative">
            ...
            <div class="mt-6">
              <AppInputLabel class="inline-flex items-center gap-2">
                <AppCheckbox v-model="form.is_editable" />
                Allow editing for non-admin
              </AppInputLabel>

              <p class="mt-2 text-sm font-medium">
                <i class="bi bi-info-circle"></i> Uncheck box above to prevent document from being edited outside the
                admin panel.
              </p>
            </div>
          ...
          <div>
            ...
            <div class="pt-4">
              <div class="px-1 py-1 mt-3 border border-dotted border-slate-500 rounded relative">
                <Editor
                  v-model="form.body"
                  menu="fixed"
                  :mentionable-keys="['%']"
