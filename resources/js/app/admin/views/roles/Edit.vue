...
<script setup>
  ...
  const form = useForm({
    name: props.model.role.name,
    type: props.model.role.type,
    parent_id: props.model.role.parent?.id,
    description: props.model.role.description,
    usable: props.model.role.usable,
    permissions: _.map(props.model.role.permissions, 'id'),
  });
  ...
  const store = () => {
    ...
    form
      ...
      .patch(route('admin.roles.update', props.model.role), {
        //
      });
  };
</script>
...
<template>
  ...
  <div class="flex flex-col gap-10 relative">
    ...
    <div class="w-full flex md:items-center px-6 mb-3">
      <!-- Heading -->
      <h1 class="text-slate-800 text-2xl font-hairline leading-tight mr-auto">Edit Role</h1>
