...
<template>
  <Head title="New Billing Plan | Admin" />
  ...
  <div class="flex flex-col gap-10 relative">
    ...
    <div class="w-full flex md:items-center justify-between px-6 mb-3">
      <!-- Heading -->
      <div class="mr-auto">
        <h1 class="text-slate-800 text-2xl font-hairline leading-tight">New Billing Plan</h1>

        <p>Once created plan some fields will not be editable.</p>
      </div>
    ...
    <div class="w-full min-w-full px-6 md:px-8 pb-6">
      ...
      >
        ...
        <div class="mt-4">
          ...
          <p class="text-sm font-semibold text-slate-500 mt-2">
            The plan's price will be <span class="text-slate-700">{{ formattedPrice }}</span>
          </p>
        ...
        <div class="mt-4">
          <AppInputLabel class="inline-flex items-center gap-2">
            <AppCheckbox v-model="form.teams" />
            For Teams
          </AppInputLabel>
        ...
        <div class="mt-4">
          <AppInputLabel class="inline-flex items-center gap-2">
            <AppCheckbox v-model="form.per_seat" />
            Per Seat
          </AppInputLabel>
