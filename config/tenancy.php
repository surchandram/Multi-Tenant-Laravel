...
return [
    ...
    'model' => [
         ...
         *
         */
        'class' => \SAAS\Domain\Companies\Models\Company::class,
    ...
    'connection' => [
        ...
        'database' => [
            ...
            'prefix' => Str::slug(env('APP_NAME', 'saas_client'), '_'),
    ...
    'routes' => [
         ...
         *
         */
        'subdomain' => env('TENANCY_ALLOW_SUBDOMAINS', false),
        ...
        'middleware' => [
             ...
             */
            'after' => [
                \SAAS\Http\Middleware\Company\RedirectIfAppNotSetup::class,
                \SAAS\Http\Middleware\Company\RedirectIfStripeNotEnabled::class.':true',
                // tenant_config
                // theme_config
            ],
    ...
    'console' => [
        ...
        'commands' => [
             ...
             */
            'migrator' => [
                // \Miracuthbert\Multitenancy\Console\MigrateFresh::class,
            ],
